...
class SentimentAnalysisML:
    ...
    def start(self):
        ...
        # randomTexts = ['Im bored as hell','Feeling sad']
        # print('Random prediction: '+vec(np.rint(network.predict(pad_sequences(t.texts_to_sequences(randomTexts), maxlen=max_doc_train, padding='post')))))
